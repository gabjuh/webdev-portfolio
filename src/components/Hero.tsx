...
const Hero: React.FC<IHero> = ({ scrollToId }) => {
  return (
    <div className="lg:col-span-2 col-span-8 lg:order-1 -order-1 mt-[10%] lg:mt-0">
      <div className="relative lg:translate-y-[136px] h-[600px] lg:h-[100%]">
        <div className="hero-content flex-col lg:flex-col">
          ...
          <div className="text-center lg:text-left">
            ...
            <a href="mailto:info@gaborjuhasz.de" className="btn btn-sm bg-transparent hover:bg-[#2db6a1] text-[#000] text-xs px-5 hover:text-[#fff] mt-7 shadow-md border-[.5px]">Kontakt</a>
          </div>
        </div>
