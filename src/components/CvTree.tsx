  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            className={`btn-categories flex flex-wrap sm:w-[100%] mx-auto z-10 pt-3 pb-1.5 sm:p-8 backdrop-filter backdrop-blur-md justify-center ${isMenuSticky && 'shadow-lg'} transition-all duration-200`}
            style={{
              position: "sticky",
              top: 0,
            }}
